 ...
 */
void SetTrackballLocation(glm::mat4 orientation, glm::vec3 translation, glm::vec3 target)
{
    g_viewMatrix = glm::lookAt(translation, target, glm::vec3(0.0f, 1.0f, 0.0f)); //glm::vec3(0.0f, 0.0f, 0.0f)
...
GLObject::GLObject()
{
    ...
    g_projectionMatrix = glm::perspective(1.0f, (float)800 / (float)600, 0.1f, 10000.f); //perspective(1.0f, (float)800 / (float)600, 0.1f, 10000.f);
    g_viewMatrix = glm::lookAt(glm::vec3(0.0f, 0.0f, 2.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
    g_invViewMatrix = glm::inverse(g_viewMatrix);
