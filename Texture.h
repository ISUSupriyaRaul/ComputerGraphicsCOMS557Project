...
#else
    const string      _glsl_names[4] = { "terrainTex", "blendmap", "mud","walkway" };
#endif
...
public:
    ...
    /*!
     ...
     @return int - the texture id when the texture was sucessfully loaded.
     */
    int loadAndCreateTextures(string path_and_file_texture_1, string path_and_file_texture_2, string path_and_file_texture_3, string path_and_file_texture_4);
