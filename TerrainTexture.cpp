...
#ifdef WIN32
string  GLMultiTexture::_glsl_names[4] = { "terrainTex", "blendmap", "mud","snow" };
...
bool GLMultiTexture::addVariablesToProgram(GLuint program, int variable_index)
{
	...
	//cout << " glsl_names[0]= " << _glsl_names[0].c_str() << " glsl_names[1]= " << _glsl_names[1].c_str() << " glsl_names[2]= " << _glsl_names[2].c_str() << " glsl_names[3]= " << _glsl_names[3].c_str() << endl;
	...
	//****************************************************************************************************
	// Link the texture to the uniform variable and texture units;
	/*
	...
	*/
	...
	//	cerr << "OpenGL error inside TerrainTexture.cpp: " << err << endl;
	//}
