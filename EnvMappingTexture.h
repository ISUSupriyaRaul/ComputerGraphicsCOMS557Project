...
*/
class GLCubmapTex : public GLTextureBase
{
private:
...
#else
	const string      _glsl_name[1] = { "skyBox" };
#endif
...
public:
	...
	*/
	int loadAndCreateCubMap(const char* path_and_file1, const char* path_and_file2, const char* path_and_file3, const char* path_and_file4, const char* path_and_file5, const char* path_and_file6);
