...
void main(void)
{
	...
	//-------------- Environment mapping : To reflect the skybox
	vec3 cameraPosition = vec3( inverseViewMatrix[3][0], inverseViewMatrix[3][1], inverseViewMatrix[3][2]);
    vec3 surfaceToCamera = normalize(surfacePostion.xyz - cameraPosition);
	pass_normal =  mat3(viewMatrixBox * modelMatrixBox) * in_Normal ;
	//pass_viewposition = (viewMatrixBox * modelMatrixBox * vec4(in_Position, 1.0)).xyz;
	pass_viewposition = surfaceToCamera;
